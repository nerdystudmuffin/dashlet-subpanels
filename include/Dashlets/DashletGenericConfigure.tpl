...
<div>
<form action='index.php' id='configure_{$id}' class="edit view" method='post' onSubmit='SUGAR.mySugar.setChooser(); return SUGAR.dashlets.postForm("configure_{$id}", SUGAR.mySugar.uncoverPage);'>
