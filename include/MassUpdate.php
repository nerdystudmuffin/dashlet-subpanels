...
//		}
		...
		$html .= "<table cellpadding='0' cellspacing='0' border='0' width='100%'><tr><td style='padding-bottom: 2px;'><input onclick='return sListView.send_mass_update(\"selected\", \"{$app_strings['LBL_LISTVIEW_NO_SELECTED']}\")' type='submit' id='update_button' name='Update' value='{$lang_update}' class='button'>";
...
eoq;
	...
	function addParent($displayname, $field){
		...
		'field_to_name_array' => array(
			...
			// End Fix
			return '<td width="15%" scope="row">' . $displayname . " </td>
			...
			<input name='parent_name' id='mass_parent_name' disabled readonly type='text' value=''>$change_parent_button</td>
			</tr></table></td>";
	}
	/**
