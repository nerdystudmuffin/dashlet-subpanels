...
$app_strings = array (
    ...
    'LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON_SHORT'     => '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_addressbook.gif').' align=absmiddle border=0> Addr...',
    ...
    'LBL_EMAIL_FOLDERS_SHORT'               => '<img src='.SugarThemeRegistry::current()->getImageURL('icon_email_folder.gif').' align=absmiddle border=0> Fo...',
    ...
    'LBL_EMAIL_SEARCH_SHORT'                => '<img src='.SugarThemeRegistry::current()->getImageURL('Search.gif').' align=absmiddle border=0> Se...',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT'    => 'Email template plain text is empty',
