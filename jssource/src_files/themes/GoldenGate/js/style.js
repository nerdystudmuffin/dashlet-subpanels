...
if (isIE6 = /msie|MSIE 6/.test(navigator.userAgent)) {
    YAHOO.util.Event.onContentReady('shortcutsextra', function(){
        SUGAR.hideMenuTimer = null;
        document.getElementById('shortcutsextra').onmouseover = function(){
        ...
        document.getElementById('shortcutsextra').onmouseout = function(){
            if (SUGAR.hideMenuTimer != null) {
                clearTimeout(SUGAR.hideMenuTimer);
            }
