...
function enableQS(noReload){
	YAHOO.util.Event.onDOMReady(function(){
        ...
        for(qsField in qsFields){
        	...
        	qs_obj = sqs_objects[qs_index_id];
            ...
            if (!document.forms[qs_obj.form].elements[qsFields[qsField].id].readOnly && qs_obj['disable'] != true) {
                ...
                if (!loaded) {
                    ...
                    Dom.setStyle(resultDiv, 'width', qsFields[qsField].clientWidth + "px");
                    ...
                    //Clear the data when no item is selected
                    search.selectionEnforceEvent.subscribe(search.clearFields)
