...
$ev = new EditView;
$xtpl->assign("TITLE1",$ev->getModuleTitle($mod_strings['LBL_CREATE_WEB_TO_LEAD_FORM'], $mod_strings['LBL_WEB_TO_LEAD_FORM_TITLE1'], true));

$xtpl->assign("TITLE2",$ev->getModuleTitle($mod_strings['LBL_CREATE_WEB_TO_LEAD_FORM'],$mod_strings['LBL_WEB_TO_LEAD_FORM_TITLE2'], true));
