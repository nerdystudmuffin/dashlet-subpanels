...
$sugarteam = array( 'Julian Ostrow', 'Lam Huynh', 'Majed Itani', "Nate D'Amico", 'Joey Parsons', 'Ajay Gupta','Jason Nassi', 'Russell Kojima', 'Andy Dreisch', 'Jeff Li',  'Roger Smith', 'Matt Heitzenroder',  'Manoj Jayadevan', 'Liliya Bederov',  'Sadek Baroudi', 'Yun-Ping Hsu', 'Rob Aagaard', 'Matt Fleeger', 'Franklin Liu', 'Jennifer Yim', 'Sujata Pamidi', 'Sharon Sim', 'Andrew Wu', 'Eddy Ramirez',  'Lori Arce', 'Jenny Gonsalves', 'Brian Kilgore',  'Mitch Lieberman', 'Vineet Dhyani', 'Collin Lee', 'Reem Bazzari',  'Joey Chao', 'Tom Brennan', 'David Kosy', 'Ken Brill', 'Jeff Tichenor', 'Tom Young', 'Chris Raffle', 'David Wheeler',  'Daniel Reverri',  'Samir Gandhi', 'Nithya Lakshmi Shunmugham', 'Navjeet Singh', 'Breno Gomes', 'Donald Wong',  'Benjamin Soufflet', 'Carlota Sage','John Mertic',  'Ran Zhou', 'Harman Birdi', 'Nitish Aitharaju', 'Nakul Chander'  );
