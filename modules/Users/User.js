 ...
 * "Powered by SugarCRM".
 */
SUGAR.user={fillGmailDefaults:function(){document.getElementById("mail_smtpserver").value='smtp.gmail.com';document.getElementById("mail_smtpport").value='465';document.getElementById("mail_smtpauth_req").checked=true;document.getElementById("mail_smtpssl").options[1].selected=true;notify_setrequired(document.getElementById("EditView"));},showHideGmailDefaultLink:function(el){var link=document.getElementById("gmailDefaults");if(el.options[el.selectedIndex].value=='SMTP'){link.style.display="inline";}else{link.style.display='none';}}}
