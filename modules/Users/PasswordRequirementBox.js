 ...
 * "Powered by SugarCRM".
 ********************************************************************************/
function confirm(){var new_pwd=document.getElementById('new_password').value;var old_pwd=document.getElementById('old_password').value;var confirm_pwd=document.getElementById('confirm_pwd');if(confirm_pwd.value!=new_pwd)
...
document.getElementById('comfirm_pwd_match').style.display='none';if(new_pwd!=""||confirm_pwd.value!=""||old_pwd!="")
...
if(form.is_admin.value!=1&&(form.portal_only&&form.portal_only.value!=1)&&form.old_password.value==""){alert(ERR_ENTER_OLD_PASSWORD);return false;}
