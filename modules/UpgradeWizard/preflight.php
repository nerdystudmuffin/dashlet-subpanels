...
//php 521 suggestion
	...
	if(version_compare(phpversion(),'5.2.1') < 0){
		$php_521="(Your current php version is ".phpversion().". Recommended php version is 5.2.1 or above)";
	}
...
$style_for_alterSchema = empty($alterTableSchema)?'style=\'display:none\'':'';
