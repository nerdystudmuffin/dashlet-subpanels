...
'.$mod_strings['LBL_UW_SHOW_DETAILS'].' <img src="'.SugarThemeRegistry::current()->getImageURL('advanced_search.gif').'"></div><div id=\'more\' style=\'display: none\'>
              ...
              .$mod_strings['LBL_UW_HIDE_DETAILS'].' <img name="options" src="'.SugarThemeRegistry::current()->getImageURL('basic_search.gif').'"></div><br>';
