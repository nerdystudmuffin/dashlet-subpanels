...
<tr>
    <td class="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_UNIFIED_SEARCH_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairUniSearch"><?php echo $mod_strings['LBL_CLEAR_UNIFIED_SEARCH_CACHE_TITLE']; ?></a></td>
...
<tr>
    <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REBUILD_EXPRESSIONS_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildExpressionPlugins"><?php echo $mod_strings['LBL_REBUILD_EXPRESSIONS_TITLE']; ?></a></td>
...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REPAIR_INDEX'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RepairIndex"><?php echo $mod_strings['LBL_REPAIR_INDEX']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_REPAIR_INDEX_DESC'] ; ?> </td>
</tr>
