...
<span style="white-space:nowrap;"> {$app_strings.LBL_EMAIL_ADDRESS_BOOK_FILTER}:<input size="10" type="text" class='input' id="contactsFilter" onkeyup="SUGAR.email2.addressBook.filter(this);">
