...
<table width="100%" border="0" cellspacing="{$GRIDLINE}" cellpadding="0">
	<tr>
		<td width="15%" valign="top"><slot>{$APP.LBL_ASSIGNED_TO}</slot></td>
		<td width="35%" valign="top"><slot>{$ASSIGNED_TO}</slot></td>
		<td width="15%"><slot>{$MOD.LBL_DATE_SENT}</slot></td>
	...
	<tr>
		...
		<td><slot>{$PARENT_TYPE}:</slot></td>
		<td><slot>{$PARENT_NAME}</slot></td>
	</tr>
	<tr>
		<td><slot>{$MOD.LBL_FROM}</slot></td>
		<td colspan=3><slot>{$FROM}</slot></td>
	</tr>
	<tr>
		<td><slot>{$MOD.LBL_TO}</slot></td>
		<td colspan='3'><slot>{$TO}</slot></td>
	</tr>
	<tr>
		<td><slot>{$MOD.LBL_CC}</slot></td>
		<td colspan='3'><slot>{$CC}</slot></td>
	</tr>
	<tr>
		<td><slot>{$MOD.LBL_BCC}</slot></td>
		<td colspan='3'><slot>{$BCC}</slot></td>
	</tr>
	<tr>
		<td><slot>{$MOD.LBL_SUBJECT}</slot></td>
		<td colspan='3'><slot>{$NAME}</slot></td>
	</tr>
	<tr>
		<td valign="top" valign="top"><slot>{$MOD.LBL_BODY}</slot></td>
	...
	<tr>
		<td valign="top"><slot>{$MOD.LBL_ATTACHMENTS}</td>
