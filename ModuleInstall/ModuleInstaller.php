	...
	function uninstall_relationship($file, $rel_dictionary = null){
       if ($rel_dictionary == null)
		...
		foreach ($rel_dictionary as $rel_name => $rel_data)
		{
			...
			if ((isset($rel_data['from_studio']) && $rel_data['from_studio'] && file_exists("custom/Extension/application/Ext/TableDictionary/custom$filename")) || 
			         !file_exists("custom/Extension/application/Ext/TableDictionary/$filename") &&
			         file_exists("custom/Extension/application/Ext/TableDictionary/custom$filename")) {
